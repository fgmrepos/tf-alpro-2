...
import model.Fila;
import controller.GeradorEstatisticas;
...
public class SimuladorController {
	...
	public SimuladorController(CategoriaCliente categoriaCliente) {
		configurador = Configurador.getInstance(categoriaCliente);
		fila = new Fila<Cliente>();
        caixa = new Caixa();
        geradorClientes = new GeradorClientes(probabilidadeChegada);
        geradorEstatisticas = new GeradorEstatisticas();
        geradorEstatisticas.statTemposEsperaFila = new Estatisticas();
        geradorEstatisticas.statComprimentosFila = new Estatisticas();
        trace = configurador.trace;
        this.simular();
    }
    ...
    public void limpar()
    {
        ...
        caixa = new Caixa();
        geradorClientes = new GeradorClientes(probabilidadeChegada);
        statTemposEsperaFila = new Estatisticas();
        statComprimentosFila = new Estatisticas();
    }
